...
if(isset($_POST['submit'])){
    ...
    $btc =$link->real_escape_string( $_POST['pm']);
    ...
    VALUES ('$btc','$usd','$btctnx','$email','pending','$tnx','$urefcode','$ureferred')";
    ...
    Your deposit of '.$usd.' USD worth of '.$btc.'  PM is currently under review, your transaction ID is '.$tnx.' , your balance will be credited once your deposit is confirmed.
    ...
    Copyright ©2010 '.$name.'. </p> <div class="be_logo" style=" width:60px;height:40px;float: right;"> </div> </div> </div> </div></div>' ;
      ...
      if($mail->send()){
        ...
        $msg= " Your deposit of $usd USD worth of $btc  PM is currently under reviews, your transaction ID is $tnx , your balance will be credited once your deposit is confirmed. ";
      }
