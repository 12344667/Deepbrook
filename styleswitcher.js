...
jQuery(document).ready(function() {
	...
	var orange = true;
		...
		$('#orange-css').on('click', function () {
			...
			if($('#is_light').is(':checked')){
				document.getElementById('logo').src='images/styleswitcher/logos/logo-light.png';
				document.getElementById('logo-mobile').src='images/styleswitcher/logos/logo-light.png';
			}
			else {
		...
		$('#blue-css').on('click', function () {
			...
			if($('#is_light').is(':checked')){
				document.getElementById('logo').src='images/styleswitcher/logos/blue-light.png';
	...
	$('#is_dark').on('click', function() {
		...
		if (orange == true) {
			...
			document.getElementById('logo-mobile').src='images/logo-light.png';
		}
		else if (green == true) {
			document.getElementById('logo').src='images/styleswitcher/logos/green-white.png';
			document.getElementById('logo-mobile').src='images/styleswitcher/logos/green-white.png';
